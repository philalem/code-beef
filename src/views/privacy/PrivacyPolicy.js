  ...
  render() {
    return (
      <div>
        ...
        <p>
          Phillip LeMaster built the Hydratee app as a Commercial app. This
          SERVICE is provided by Phillip LeMaster and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Hydratee unless otherwise
        ...
        <p>
          ...
          but not limited to sessions. The information that I request will be
        ...
        <p>This policy is effective as of 2020-07-21</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at Phillip LeMaster.
        </p>{" "}
        <p>
